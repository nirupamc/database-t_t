 ...
 */
export async function getRecruiterSettingsAction(): Promise<{
  id: string;
  name: string;
  email: string;
  phone: string | null;
  ...
  console.log("[Settings] Fetching recruiter settings for:", user.id);
  ...
  console.log("[Settings] calendarConnected:", recruiter.calendarConnected);
